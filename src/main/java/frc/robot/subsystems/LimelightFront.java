...
public class LimelightFront extends Limelight {
    ...
    public Translation2d getBotXY() {
        ...
        if(DriverStation.getAlliance().get() == Alliance.Red){
            result = LimelightHelpers.getBotPose_wpiRed(limelightName);
        }
        else{
    ...
    public int getTagsSeen() {
        return LimelightHelpers.getNumberOfAprilTagsSeen(limelightName);
    }
    ...
    public String getJSONDump() {
        return LimelightHelpers.getJSONDump(limelightName);
    }

    public void checkForAprilTagUpdates(SwerveDrivePoseEstimator odometry) {
        int tagsSeen = LimelightHelpers.getNumberOfAprilTagsSeen(limelightName);
    ...
    public Translation2d getAprilTagCoordinates(int tagNumber){
        return LimelightHelpers.getAprilTagCoordinates(tagNumber);
    }

    public int getClosestColumn(Translation2d pose, boolean isCube){
        return LimelightHelpers.getClosestColumn(pose, isCube);
    }    
}